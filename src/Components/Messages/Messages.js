...
class Messages extends React.Component {
    ...
    state = {
        ...
        countUniqueUsers = messages => {
            ...
            const numUniqUsers = `${uniqueUsers.length} user${plural ? "s": ""}`;
    ...
    render() {
        ...
        const { messagesRef , messages , channel , user ,  numUniqUsers , searchTerm , searchResults,
