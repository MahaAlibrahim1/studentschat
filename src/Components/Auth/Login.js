    ...
    render ()
    {
        ...
        return(
            <Grid textAlign="center" verticalAlign="middle" className="app">
               ...
               <Icon name="pencil alternate" color="violet"/>
               Login to Students Chat
               </Header>
               ...
               <Segment stacked>
                   ...
                   <Button disabled={loading} className={loading ? 'laoding' : ''} color="violet" fluid size="large"> Submit</Button>
               </Segment>
               </Form>
                {errors.length > 0 && (
                    <Message error> 
